...
const SPEAKER_NOTES = {
  ...
  sarah:
    "[~3 min] THE URGENT EXAMPLE - REFRAMED. No more fictional Sarah/chat mockup. Three field signals every CIO in the room is already seeing in their own org. Audience-self-recognition is the move.\n\nOPEN: 'The four-system tax doesn't show up as a slide in your roadmap deck. It shows up like this.' (read off the slide)\n\nWALK THE THREE SIGNALS - one beat each, ~30 sec:\n\n01 - 'Your AI/ML team is hiring a vector DB specialist.'\n   - Why: the new roadmap features need a vector store nobody on the platform team knows how to operate. So you're staffing a new specialty.\n   - Pause. Ask the room: 'Who's posted that req in the last quarter?' (don't wait for answer - rhetorical, but it lands)\n\n02 - 'Your platform team is debating which database is the source of truth for the agent.'\n   - Why: the agent's memory lives in three places that disagree. Every refactor proposal is really a sync-strategy proposal.\n   - Tie back: 'This is the picture we just drew - vector / search / SQL / analytics, and your team is fighting about which one wins.'\n\n03 - 'Your CFO is asking why each AI feature has its own data infrastructure line item.'\n   - Why: every AI feature on the standard architecture comes with four new systems. By feature five, the line item is conspicuous.\n   - This is the cost-benefit tie-in - say it the way the CFO says it.\n\nLAND (read the closing line slowly):\n'You don't have a Pinterest-scale problem yet. You have a hiring-plan problem. Same architecture - different stage.'\n\nKEY POINT TO LAND: This slide is the room recognizing themselves. The fictional retail VIP is gone - this is what's brewing in their hiring plans, their architecture reviews, and their CFO's Q3 questions.\n\nBRIDGE TO MEMORIES: 'So what does the answer look like? Three patterns of memory the agent needs - and TiDB makes all three live in one ACID query.'",
