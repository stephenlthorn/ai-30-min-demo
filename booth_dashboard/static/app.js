...
const SPEAKER_NOTES = {
  ...
  librarian:
    "ONE-MINUTE SLIDE. The librarian analogy is the punchline of this beat.\n\nKEY LINES:\n- 'Storing memory is half the job. The other half is curation.'\n- 'A librarian doesn't dump 10,000 books on the table. She picks the right four for the question you asked.'\n- THE TRAP: 'Model providers will sell you a 1M-token window as the answer. It benefits THEM, not you. Every token you load, you pay for. A bigger window is a bigger meter - it is not memory.'\n\nLAND ON: 'The win is curation, not capacity.' That line resets the audience's mental model of what 'AI memory' actually means.\n\nBRIDGE TO CMA: 'OK - now what keeps the library honest over time?'",
