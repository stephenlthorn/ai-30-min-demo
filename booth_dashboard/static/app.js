...
const SPEAKER_NOTES = {
  ...
  byoc:
    "[~2 min] BYOC - the regulated industries objection-killer. Short slide, big impact for healthcare CIOs (Icon Health, NYBC), financial services, government. Skip if no regulated industries in the room.\n\nOPEN: 'One question I get from every regulated CIO: where does my data live? With BYOC, the answer is your cloud account.'\n\nWALK THE THREE BULLETS - 30 sec each:\n\n01 - FULL DATA SOVEREIGNTY\n   - 'TiDB cluster runs inside your AWS, Azure, or GCP account. Your VPC. Your IAM. Your encryption keys. PingCAP's control plane manages it; we never see your data.'\n\n02 - 3-4 HOUR DEPLOY\n   - 'PrivateLink, 13 static IAM roles, fully scripted. SOC 2 Type II. HIPAA-eligible. Your CISO's checklist runs through fast because the architecture was designed for it.'\n\n03 - PINGCAP MANAGED, NO DATA ACCESS\n   - 'We handle upgrades, scaling, observability - all via the control plane. Audit logs of every operation. Your CISO signs off, not us.'\n\nLAND: 'Healthcare. Financial services. Government. Your data stays in your account.'\n\nKEY POINT TO LAND: This kills the #1 objection from regulated industries before they even raise it. Don't dwell - it's a confidence builder, not the talk's spine.\n\nBRIDGE TO MEMORIES: 'OK - architecture is built, deployment is safe. Now let's talk about the workload that drives most of this conversation: agent memory.'",
