...
const SLIDES = [
  ...
  { id: "tidbx",       label: "TiDB X",           shortLabel: "7" },
  { id: "memories",    label: "Three Memories",   shortLabel: "8" },
  { id: "maya",        label: "Maya's Year",      shortLabel: "9" },
  { id: "librarian",   label: "Token Tax",        shortLabel: "10" },
  { id: "manus",       label: "AI-Native Threat", shortLabel: "11" },
  { id: "byoc",        label: "BYOC",             shortLabel: "12" },
...
const SPEAKER_NOTES = {
  ...
  tidbx:
    "[~3 min] TIDB X - the platform credibility slide. Says: this isn't your 2015 distributed SQL story - this is the 2026 architecture purpose-built for the workload that didn't exist when most of your stack was designed.\n\nOPEN: 'TiDB has been in production 11 years. TiDB X is the rebuild for the cloud era - same MySQL wire your team already speaks, completely different economics underneath.'\n\nWALK THE FOUR PILLARS - one beat each, ~30 sec:\n\n01 - STORAGE: S3 as source of truth\n   - 'Object storage is the source of truth - not block storage. Native AWS S3, GCS, Azure Blob. This is what makes the cost story work.'\n\n02 - ISOLATION: Microservices for the noisy work\n   - 'Compaction, analyze, DDL, index builds run on separate workers. Your AI vector workloads don't disturb your OLTP. Same cluster, different lanes.'\n   - For the room: 'This is the answer to your platform team's question - what happens when AI traffic spikes. It doesn't take down your transactions.'\n\n03 - SCALE: 3-5x faster scale operations\n   - 'Auto-scaling within seconds. Pay-as-you-go pricing. 100TB+ clusters back up in minutes, not hours.'\n\n04 - COST: Up to 80% lower cost\n   - 'For cold-data-heavy estates. Cloud-grade durability without the EBS bill. This is the line your CFO will care about most.'\n\nLAND: 'One unified platform - OLTP, OLAP, Gen-AI workloads.'\n\nKEY POINT TO LAND: TiDB X is the credibility story. Audience walks away knowing your 2026 platform exists, is cloud-native, and is architecturally aligned with where AI workloads are going.\n\nBRIDGE TO MEMORIES: 'OK - architecture is built, capabilities are named. Now let's talk about the workload that actually drives most of this conversation: agent memory.'",
