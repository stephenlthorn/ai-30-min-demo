...
const SPEAKER_NOTES = {
  ...
  whynow:
    "Two beats: the urgency, then the friction-removed.\n\nURGENCY (the lede): 'The architecture choices being made right now decide who wins AI-native retail in 2028. Same curve as cloud, 2012 to 2015 - the brands that picked their cloud architecture early dominated the next decade. Patterns calcify. Switching costs compound.'\n\nFRICTION-REMOVED (the 3 cards): 'And the friction that used to keep this off your roadmap is already gone:'\n- Procurement: on every cloud marketplace, burns down existing commit\n- Security: deploys in your cloud tenant, your IAM/keys/CISO\n- Migration: MySQL-compatible, Aurora to TiDB in a weekend\n\nKEY LINE: 'Not a model gap. An architecture gap. Architecture gaps don't close.'\n\nBRIDGE TO CLOSE: 'Here's what you walked in with - and what you walk out knowing.'",
