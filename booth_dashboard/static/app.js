...
const SLIDES = [
  ...
  { id: "librarian",   label: "Token Tax",      shortLabel: "6" },
  { id: "manus",       label: "Manus Math",     shortLabel: "7" },
  { id: "about-tidb",  label: "About TiDB",     shortLabel: "8" },
...
const SPEAKER_NOTES = {
  ...
  "about-tidb":
    "Quick credibility moment - 30 seconds, max. The audience just absorbed the demo and the economics. Now answer the unspoken question: 'Is TiDB a real company or some startup that's going to disappear?'\n\nKEY POINTS:\n- 11+ years in production. Shipped 2015. Not a startup pivoting to AI.\n- Pinterest runs a million-QPS graph on it.\n- Manus runs 10M+ databases on it.\n- MySQL-compatible - your apps don't change.\n\nLAND: 'Same architecture - new workload. The labs that build AI use what already scales commerce.'\n\nBRIDGE TO WHY NOW: 'And the window to decide is narrower than most people think.'",
